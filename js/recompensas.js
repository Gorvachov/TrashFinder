      ...
      <div class="modal-compartir-content">
        ...
        <div style="margin-bottom: 1.5rem;">
          ...
          <div class="social-buttons-grid">
            <button class="btn-social-share facebook" onclick="compartirEnRed('facebook')">
            ...
            <button class="btn-social-share twitter" onclick="compartirEnRed('twitter')">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
            ...
            <button class="btn-social-share whatsapp" onclick="compartirEnRed('whatsapp')">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
        ...
        <div style="display: flex; gap: 0.8rem; margin-top: 1rem;">
          <button class="btn btn-secondary" onclick="cerrarModalCompartir()" style="flex: 1;">Cancelar</button>
          <button class="btn btn-outline" onclick="copiarEnlace()" style="flex: 1;">📋 Copiar enlace</button>
        </div>
